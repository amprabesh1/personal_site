...
>
      ...
      <div className="w-full flex justify-center">
        <form
          ...
          className="w-[80%] h-full flex flex-col gap-4 pt-4 text-primary-400 dark:text-primary-200"
        >
          <div className="w-full flex flex-col">
          <label htmlFor="firstname" style={{ fontWeight: 'bold', fontSize: '18px' }}>First Name</label>
            <input
              className="p-[0.5em] rounded-xl text-grayscale-950 dark:text-white bg-primary-200 dark:bg-dark-card"
